...
export interface ApiChampionshipChampionship extends Schema.CollectionType {
  ...
  attributes: {
    races: Attribute.Relation<
      ...
      'api::race.race'
    >;
    ChampionshipTitle: Attribute.String;
    slug: Attribute.UID;
    ChampionshipImage: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiCupCup extends Schema.CollectionType {
  collectionName: 'cups';
  info: {
    singularName: 'cup';
    pluralName: 'cups';
  ...
  attributes: {
    CupName: Attribute.String;
    CupImage: Attribute.Media;
    slug: Attribute.UID<'api::cup.cup', 'CupName'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::cup.cup', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::cup.cup', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
